...
ZIP="https://github.com/HiromuHota/pdi-git-plugin/releases/download/nightly/pdi-git-plugin-1.1.0-SNAPSHOT-jar-with-dependencies.zip"
FILE=pdi-git-plugin-1.1.0-SNAPSHOT-jar-with-dependencies.zip
